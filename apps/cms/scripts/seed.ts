...
const cloudinaryBase = (publicId: string) =>
  `https://res.cloudinary.com/${process.env.CLOUDINARY_NAME}/image/upload/q_80,w_1600/${publicId}.jpg`;

const uploadFromCloudinary = async (strapi: any, publicId: string) => {
...
const upsertCollectionEntry = async (strapi: any, uid: string, slug: string, data: any) => {
